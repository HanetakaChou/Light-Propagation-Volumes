                     ...
                     int LPV3DDepth)
{
    ...
    SHred = zLw * float4(LPVRed_0.Sample(samLinear, lookupCoordsLow).x, LPVRed_1.Sample(samLinear, lookupCoordsLow).x, LPVRed_2.Sample(samLinear, lookupCoordsLow).x, LPVRed_3.Sample(samLinear, lookupCoordsLow).x) + zHw * float4(LPVRed_0.Sample(samLinear, lookupCoordsHigh).x, LPVRed_1.Sample(samLinear, lookupCoordsHigh).x, LPVRed_2.Sample(samLinear, lookupCoordsHigh).x, LPVRed_3.Sample(samLinear, lookupCoordsHigh).x);
    SHgreen = zLw * float4(LPVGreen_0.Sample(samLinear, lookupCoordsLow).x, LPVGreen_1.Sample(samLinear, lookupCoordsLow).x, LPVGreen_2.Sample(samLinear, lookupCoordsLow).x, LPVGreen_3.Sample(samLinear, lookupCoordsLow).x) + zHw * float4(LPVGreen_0.Sample(samLinear, lookupCoordsHigh).x, LPVGreen_1.Sample(samLinear, lookupCoordsHigh).x, LPVGreen_2.Sample(samLinear, lookupCoordsHigh).x, LPVGreen_3.Sample(samLinear, lookupCoordsHigh).x);
    SHblue = zLw * float4(LPVBlue_0.Sample(samLinear, lookupCoordsLow).x, LPVBlue_1.Sample(samLinear, lookupCoordsLow).x, LPVBlue_2.Sample(samLinear, lookupCoordsLow).x, LPVBlue_3.Sample(samLinear, lookupCoordsLow).x) + zHw * float4(LPVBlue_0.Sample(samLinear, lookupCoordsHigh).x, LPVBlue_1.Sample(samLinear, lookupCoordsHigh).x, LPVBlue_2.Sample(samLinear, lookupCoordsHigh).x, LPVBlue_3.Sample(samLinear, lookupCoordsHigh).x);
}
