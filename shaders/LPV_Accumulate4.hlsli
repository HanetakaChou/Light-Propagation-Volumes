...
[numthreads(X_BLOCK_SIZE, Y_BLOCK_SIZE, Z_BLOCK_SIZE)] void AccumulateLPV_singleFloats_8(uint threadId
                                                                                         : SV_GroupIndex,
                                                                                           uint3 groupId
                                                                                         : SV_GroupID,
                                                                                         ...
                                                                                         : SV_DispatchThreadID)
{
    ...
    [numthreads(X_BLOCK_SIZE, Y_BLOCK_SIZE, Z_BLOCK_SIZE)] void AccumulateLPV_singleFloats_4(uint threadId
                                                                                             : SV_GroupIndex,
                                                                                               uint3 groupId
                                                                                             : SV_GroupID,
                                                                                               uint3 globalThreadId
