...
#ifndef NDEBUG
#include "../build/dxbc/Debug/Hierarchy_DownsampleMax_bytecode.inl"
#include "../build/dxbc/Debug/Hierarchy_DownsampleMin_bytecode.inl"
#include "../build/dxbc/Debug/Hierarchy_DownsampleAverage_bytecode.inl"
#include "../build/dxbc/Debug/Hierarchy_DownsampleAverageInplace_bytecode.inl"
#include "../build/dxbc/Debug/Hierarchy_Upsample_bytecode.inl"
#include "../build/dxbc/Debug/Hierarchy_UpsampleBilinear_bytecode.inl"
#include "../build/dxbc/Debug/Hierarchy_UpsampleBilinearAccumulate_bytecode.inl"
#include "../build/dxbc/Debug/Hierarchy_UpsampleBilinearAccumulateInplace_bytecode.inl"
#else
#include "../build/dxbc/Release/Hierarchy_DownsampleMax_bytecode.inl"
#include "../build/dxbc/Release/Hierarchy_DownsampleMin_bytecode.inl"
#include "../build/dxbc/Release/Hierarchy_DownsampleAverage_bytecode.inl"
#include "../build/dxbc/Release/Hierarchy_DownsampleAverageInplace_bytecode.inl"
#include "../build/dxbc/Release/Hierarchy_Upsample_bytecode.inl"
#include "../build/dxbc/Release/Hierarchy_UpsampleBilinear_bytecode.inl"
#include "../build/dxbc/Release/Hierarchy_UpsampleBilinearAccumulate_bytecode.inl"
#include "../build/dxbc/Release/Hierarchy_UpsampleBilinearAccumulateInplace_bytecode.inl"
#endif
...
public:
    ...
    SimpleRT *getRed(bool front = true)
    {
        int Buffer = front ? m_currentBuffer : getBackbufferIndex();
        return Red[Buffer];
    }
    SimpleRT *getBlue(bool front = true)
    {
        int Buffer = front ? m_currentBuffer : getBackbufferIndex();
        return Blue[Buffer];
    }
    SimpleRT *getGreen(bool front = true)
    {
        int Buffer = front ? m_currentBuffer : getBackbufferIndex();
        return Green[Buffer];
    }
...
public:
    ...
    void Downsample(ID3D11DeviceContext *pd3dContext, int finerLevel, DOWNSAMPLE_TYPE op)
    {
        ...
        if (finerLevel < 0 || coarserLevel >= m_levels)
            return;
