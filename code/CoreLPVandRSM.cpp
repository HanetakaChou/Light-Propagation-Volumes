...
void propagateLPV_PixelShaderPath(ID3D11DeviceContext *pd3dContext, int iteration, SimpleRT_RGB *LPVPropagate, SimpleRT_RGB *LPVAccumulate, SimpleRT *GV, SimpleRT *GVColor)
{
    ...
    if (iteration < 2)
    {
        ...
        if (iteration < 1 || !g_useOcclusion)
            pcbGV->useGVOcclusion = 0;
        else
            pcbGV->useGVOcclusion = 1;
        ...
        if (iteration < 1)
            pcbGV->copyPropToAccum = 1;
        else
            pcbGV->copyPropToAccum = 0;
    ...
    ID3D11RenderTargetView *pRTVLPV[6] = {LPVPropagate->getRedFront()->get_pRTV(0), LPVPropagate->getGreenFront()->get_pRTV(0), LPVPropagate->getBlueFront()->get_pRTV(0), LPVAccumulate->getRedFront()->get_pRTV(0), LPVAccumulate->getGreenFront()->get_pRTV(0), LPVAccumulate->getBlueFront()->get_pRTV(0)};
